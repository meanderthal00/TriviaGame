$(document).ready(function () {
    ...
    var questionArray = [{
        ...
        question4: {
            "What surprising part of the Moose do the Canadians turn into a jelly?",
            choices4: {
                [
                    "The 'knuckle'.",
                    "The antlers",
        ...
        question5: {
            "What insect first eaten under duress, has become a staple in the diet of many Cambodians?",
            choices5: {
                [
